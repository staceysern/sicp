(ns sicp.2-10-test
  (:require [midje.sweet :refer :all]
            [sicp.2-10 :refer :all]
            [sicp.interval :refer [make-interval div-interval]]))
...
(facts "make-center-percent"
  ...
  (div-interval-with-error-checking lower-zero pos)
  => (div-interval lower-zero pos)

  (div-interval-with-error-checking neg lower-zero) => (throws Exception)

  (div-interval-with-error-checking upper-zero neg)
  => (div-interval upper-zero neg)
